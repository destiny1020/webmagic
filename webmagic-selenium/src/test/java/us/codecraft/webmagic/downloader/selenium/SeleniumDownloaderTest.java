...
/**
 * @author code4crafter@gmail.com <br> Date: 13-7-26 <br> Time: 下午2:46 <br>
 */
public class SeleniumDownloaderTest {
  ...
  public void testBaiduWenku() {
    ...
    Page page = seleniumDownloader
        .download(new Request("http://wenku.baidu.com/view/462933ff04a1b0717fd5ddc2.html"),
            new Task() {
              @Override
              public String getUUID() {
                return "huaban.com";
    ...
    System.out
        .println(page.getHtml().$("div.inner").replace("<[^<>]+>", "").replace("&nsbp;", "").all());
  }
