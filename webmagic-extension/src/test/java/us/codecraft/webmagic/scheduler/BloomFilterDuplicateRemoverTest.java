...
public class BloomFilterDuplicateRemoverTest {
  ...
  public void testMemory() throws Exception {
    ...
    System.out
        .println("Memory used by bloomfilter:" + (freeMemory - Runtime.getRuntime().freeMemory()));
    ...
    System.out
        .println("Memory used by hashset:" + (freeMemory - Runtime.getRuntime().freeMemory()));
  }
  ...
  public void testMissHit() throws Exception {
    ...
    System.out
        .println("Right count: " + right + " Wrong count: " + wrong + " Miss check: " + missCheck);
  }
