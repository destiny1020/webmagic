...
public @interface TargetUrl {
  ...
  /**
   * Define the region for url extracting. <br> Only support XPath.<br> When sourceRegion is set,
   * the urls will be extracted only from the region instead of entire content. <br>
   *
