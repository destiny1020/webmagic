...
public @interface ExtractByUrl {
  ...
  /**
   * Define whether the extractor return more than one result. When set to 'true', the extractor
   * return a list of string (so you should define the field as List). <br>
   *
