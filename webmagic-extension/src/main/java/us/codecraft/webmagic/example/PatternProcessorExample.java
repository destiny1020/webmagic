...
public class PatternProcessorExample {
  ...
  public static void main(String... args) {
    ...
    PatternProcessor githubRepoProcessor = new PatternProcessor(
        "https://github\\.com/[\\w\\-]+/[\\w\\-]+") {

      @Override
      public RequestMatcher.MatchOther processPage(Page page) {
        page.putField("reponame",
    ...
    PatternProcessor githubUserProcessor = new PatternProcessor("https://github\\.com/[\\w\\-]+") {
      ...
      public RequestMatcher.MatchOther processPage(Page page) {
        ...
        page.putField("username",
            page.getHtml().xpath("//span[@class='vcard-fullname']/text()").toString());
        return RequestMatcher.MatchOther.YES;
      }
    ...
    CompositePageProcessor pageProcessor = new CompositePageProcessor(
        Site.me().setDomain("github.com").setRetryTimes(3));
    ...
    Spider.create(pageProcessor).addUrl("https://github.com/code4craft").thread(5)
        .addPipeline(pipeline).runAsync();
  }
