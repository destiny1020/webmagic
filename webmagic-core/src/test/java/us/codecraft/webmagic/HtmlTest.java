...
/**
 * @author code4crafter@gmail.com <br> Date: 13-4-21 Time: 上午8:42
 */
public class HtmlTest {
  ...
  public void testGetHrefsByJsoup() {
    ...
    assertThat(html.xpath("//a[1]/@abs:href").get())
        .isEqualTo("https://github.com/code4craft/webmagic/issues");
    assertThat(html.xpath("//img/@abs:src").get())
        .isEqualTo("https://github.com/code4craft/webmagic/webmagic.jpg");
    html = new Html(
