...
public class Site {
  ...
  /**
   * Put an Http header for downloader. <br> Use {@link #addCookie(String, String)} for cookie and
  ...
  public boolean equals(Object o) {
    ...
    if (acceptStatCode != null ? !acceptStatCode.equals(site.acceptStatCode)
    ...
    if (defaultCookies != null ? !defaultCookies.equals(site.defaultCookies)
