...
/**
 * @author code4crafter@gmail.com <br> Date: 13-5-20 Time: 下午5:31
 */
public class MeicanProcessor implements PageProcessor {
  ...
  public void process(Page page) {
    ...
    page.putField("prices", page.getHtml().xpath(
        "//ul[@class=\"dishes menu_dishes\"]/li/span[@class=\"price_outer\"]/span[@class=\"price\"]/text()"));
  }
