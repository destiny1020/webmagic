...
/**
 * @author code4crafter@gmail.com <br> Date: 13-4-20 Time: 下午7:46
 */
...
//                processor(pageProcessor).run();
    SimplePageProcessor pageProcessor2 = new SimplePageProcessor(
    ...
    Spider.create(pageProcessor2).addUrl(
